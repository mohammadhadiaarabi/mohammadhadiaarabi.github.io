...
I am supervised by [Samir Suweis](https://suweis.github.io/), and I collaborate with the laboratory of [Stefano Vassanelli](https://www.vassanellilab.eu/people/) and with [Ramon Guevara Erra](https://loop.frontiersin.org/people/27121/overview).

I have been studying the brain criticality hypothesis in the rat barrel cortex, focusing in particular on studying criticality or deviations thereof in perturbed conditions (see for example [here](https://www.frontiersin.org/articles/10.3389/fnsys.2021.709677/full)). I've also focused on disentangling the contributions of external and intrinsic network dynamics on the signatures of criticality that we observed in the rat barrel cortex (see for example [here](https://arxiv.org/abs/2105.05070)).
...
the processing of a sensory input and in understanding their functional role. The understanding of these properties would enable to induce desired oscillations and responses in the barrel cortex, i. e. to control the system.
