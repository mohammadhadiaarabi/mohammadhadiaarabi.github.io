...
```
In order to get the PRC, in the above lines of codes the parameter the values of the external current is increased at random times in order to simulate istantaneous stimulations. After simulating the model, for each phase at which the stimulation arrives one studies the value of the induced phase shift. In this case the obtained phase response curve is [this](https://github.com/benedetta-mariani/benedetta-mariani.github.io/blob/master/images/PRCtypeII.png)
...
The [PRC]("https://github.com/benedetta-mariani/benedetta-mariani.github.io/blob/master/images/PRCtypeI.png") obtained now is of type I.
