...
date: 2021-10-30
permalink: /posts/2021-10-30-blog-post-1/
tags:
  - cool posts
  - category1
  - category2
...
```
In order to get the PRC, in the above lines of codes the parameter the values of the external current is increased at random times in order to simulate istantaneous stimulations. After simulating the model, for each phase at which the stimulation arrives one studies the value of the induced phase shift. In this case the obtained phase response curve is the following

<img src="https://github.com/benedetta-mariani/benedetta-mariani.github.io/blob/master/images/PRCtypeII.png " width="250" height="180">
...
<img src="https://github.com/benedetta-mariani/benedetta-mariani.github.io/blob/master/images/PRCtypeI.png" width="250" height="180">

Now thus the PRC obtained is of type I.
